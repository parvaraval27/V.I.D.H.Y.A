...
const embedUrl = 'https://careercanvasweb.vercel.app/';
          ...
          <div className="flex-1 max-w-4xl">
            <div className="bg-gradient-to-br from-white to-purple-50/30 rounded-3xl shadow-2xl border-4 border-purple-300 overflow-hidden" style={{ boxShadow: '0 20px 60px rgba(126, 34, 206, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.6)' }}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-4">
                      <div className="bg-white rounded-xl p-5 border-2 border-purple-200 shadow-md hover:shadow-xl transition-all hover:border-purple-400 relative overflow-hidden group">
                        ...
                        <div className="relative">
                          ...
                          <p className="text-sm text-gray-600">Use curated templates and structured sections to build a resume quickly</p>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl p-5 border-2 border-purple-200 shadow-md hover:shadow-xl transition-all hover:border-purple-400 relative overflow-hidden group">
                        ...
                        <div className="relative">
                          ...
                          <p className="text-sm text-gray-600">Customize sections based on job descriptions for better fit</p>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl p-5 border-2 border-purple-200 shadow-md hover:shadow-xl transition-all hover:border-purple-400 relative overflow-hidden group">
                        ...
                        <div className="relative">
                          ...
                          <p className="text-sm text-gray-600">Export to PDF and share with recruiters</p>
                        </div>
                      </div>
                      ...
                      <div className="bg-white rounded-xl p-5 border-2 border-purple-200 shadow-md hover:shadow-xl transition-all hover:border-purple-400 relative overflow-hidden group">
                        ...
                        <div className="relative">
                          ...
                          <p className="text-sm text-gray-600">Get feedback and iterate with peers or mentors</p>
                        </div>
                      </div>
                </div>
              </div>
              ...
              <div className="px-8 py-4 border-t-2 border-purple-200 bg-purple-50/50 flex justify-between items-center">
                <div className="text-sm text-gray-500">V.I.D.H.Y.A • CareerCanvas Module</div>
                <div className="text-sm text-gray-500" style={{ fontFamily: 'Georgia, serif' }}>Page 2</div>
              </div>
            </div>
          ...
          <div className="h-full flex flex-col">
            <div className="flex items-center justify-between px-6 py-4 border-b-2 border-purple-300 bg-gradient-to-r from-purple-50 to-purple-100">
              <div className="flex items-center gap-3">
                ...
                <h3 className="text-2xl text-purple-800" style={{ fontFamily: 'Georgia, serif' }}>CareerCanvas - Resume Builder</h3>
              </div>
...
export default CareerCanvasPage;
