...
export default function NotebookLayout({ title, beforeTitle, children, full = true, wide = false }: NotebookLayoutProps) {
  return (
    <section className={`notebook ${full ? 'notebook-full' : ''} mb-6 overflow-x-hidden mx-auto max-w-[1495px] px-2 sm:px-4`}> 
      <div className="spiral hidden md:flex flex-col items-center justify-center">
        ...
        <div className={wide ? 'pl-4 md:pl-12 pr-4 md:pr-12 w-full mx-auto max-w-[1200px] box-border' : 'pl-4 md:pl-12 pr-4 md:pr-12 w-full max-w-[1200px] mx-auto box-border'}>  
